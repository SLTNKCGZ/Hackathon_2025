...
class _QuestionsPageState extends State<QuestionsPage> with TickerProviderStateMixin {
  List<Map<String, dynamic>> lessons = [];
  Map<int, List<Map<String, dynamic>>> terms = {};
  Map<int, Map<int, List<Map<String, dynamic>>>> questions = {}; // lesson_id -> term_id -> questions
  ...
  Future<void> fetchQuestions(int lessonId, int termId) async {
    final response = await http.get(
      Uri.parse('http://10.0.2.2:8000/questions/$lessonId/$selectedStarRating/$termId'),
      headers: {'Authorization': 'Bearer ${widget.token}'},
    );
    if (response.statusCode == 200) {
      setState(() {
        ...
        builder: (context, setDialogState) => AlertDialog(
              ...
              children: [
                ...
                Row(
                  ...
                  children: List.generate(3, (index) => Icon(
                    index < selectedStarRating ? Icons.star : Icons.star_border,
                    color: Colors.orange,
                    size: 24,
                  )),
                ),
          ...
          actions: [
            ...
            TextButton(
                onPressed: () async {
                  if (lessons != null) {
                    await createQuestion(lessonId, termId, selectedImage!, questionController.text);
                    Navigator.pop(context);
                  } else {
  ...
  Future<void> createQuestion(int lessonId, int termId, File imageFile, String note) async {
    try {
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              GestureDetector(
                onTap: () => showAddTopicDialog(lessonId, lessons.firstWhere((l) => l['id'] == lessonId)['title']),
                child: Container(
        ...
        ...lessonTerms.asMap().entries.map((entry) {
          ...
          List<Map<String, dynamic>> termQuestions = questions[lessonId]?[termId] ?? [];
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Spacer(),
                    GestureDetector(
                      onTap: () => showAddQuestionDialog(lessonId, termId, termTitle),
                      child: Container(
                        padding: EdgeInsets.all(8),
                        decoration: BoxDecoration(
                          color: Colors.purple[300],
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Row(
                    children: List.generate(3, (index) => Icon(
                      index < question['difficulty_category'] ? Icons.star : Icons.star_border,
                      color: difficultyColor,
                      size: 16,
                    )),
                  ),
